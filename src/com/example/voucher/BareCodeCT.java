...
public class BareCodeCT extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * mainEdtSta = (EditText) findViewById(R.id.mainEdtSta); mainEdtQuan =
		 * (EditText) findViewById(R.id.mainEdtQuan); mainEdtPro = (EditText)
		 * findViewById(R.id.mainEdtProductname); mainEdtCre = (EditText)
		 * findViewById(R.id.mainEdtcre);
		 */

		
		 if (mBluetoothAdapter == null) { Toast.makeText(this,
		  "khong ho tro barecode", Toast.LENGTH_LONG) .show(); finish();
		 return; }
